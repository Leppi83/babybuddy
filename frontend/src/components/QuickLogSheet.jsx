...
const TILES = [
  { key: "diaper", labelKey: "quickLog.tile.diaper", icon: "💧", instant: true },
  { key: "feeding", labelKey: "quickLog.tile.feeding", icon: "🍼", instant: true },
  { key: "sleep", labelKey: "quickLog.tile.sleep", icon: "😴", instant: true },
  { key: "pumping", labelKey: "quickLog.tile.pumping", icon: "🫧", instant: true },
  { key: "temperature", labelKey: "quickLog.tile.temperature", icon: "🌡️", instant: false },
  { key: "timer", labelKey: "quickLog.tile.timer", icon: "⏱️", instant: true },
  { key: "note", labelKey: "quickLog.tile.note", icon: "📝", instant: false },
  { key: "weight", labelKey: "quickLog.tile.weight", icon: "⚖️", instant: false },
];
...
function TileButton({ tile, child, csrfToken, quickStatus, onInstantLog, strings }) {
